        ...
        <div className="px-[32px]">
          ...
          <div className="mb-8 flex flex-col lg:mb-12 lg:flex-row lg:items-start lg:justify-between">
            <div className="mb-6 lg:mb-0 lg:w-[54%] 2xl:w-[40%]">
              <h2 className="font-bebas text-dark-gray text-4xl tracking-wide uppercase md:text-5xl lg:text-[72px]">
          ...
          <div className="relative h-[400px] md:h-[500px] lg:h-[800px] 2xl:h-[1080px]">
            <Image
              src="/abt-1.png"
            ...
            <div className="absolute bottom-6 left-6 max-w-xs lg:max-w-lg">
              <p className="font-open-sans text-xs leading-relaxed text-[#999] sm:text-base">
